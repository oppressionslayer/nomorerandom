...
for x in range (1, interval):
   ...
   if justprevious != 'TRUE':
       if debug == 'TRUE':
         ...
         print ( 'New RNG Number: ', current, ' Distance to +/- Main Guess: ', distance, 'Main Guess: ', previous, 'Guess #1: ', distAdd, 'Guess #2: ', distSub, 'distance from RNG to Guesses: ', newdistance)
   else: 
       if debug == 'TRUE':
         print ( 'New RNG Number: ', current, ' Distance to +/-  Previous: ', distance, 'Previous: ', previous, 'Guess #1: ', distAdd, 'Guess #2: ', distSub, 'distance from RNG to Guesses: ', newdistance)
